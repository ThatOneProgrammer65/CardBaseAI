...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/yUFTCmrfjQ)
...
```sh
npx nx serve cardbaseAI
```

To create a production bundle:

```sh
npx nx build cardbaseAI
```

To see all available targets to run for a project, run:

```sh
npx nx show project cardbaseAI
```
